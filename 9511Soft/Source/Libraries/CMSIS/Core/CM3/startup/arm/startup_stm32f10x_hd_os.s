...
;   ----------------------------------------------------------------------------
;   File Name          : startup_stm32f10x_hd_os.s
;   Description        : 中断向量和启动代码
;   ----------------------------------------------------------------------------
;   History:

;   y10/m05/d12     v0.01   chenyong    setup
;   由文件 startup_stm32f10x_hd.s 改写
;   改写了两个中断: PendSV 和 SysTick
...
; Vector Table Mapped to Address 0 at Reset
                ...
                ; for os,   cy  100512  added
                IMPORT  OS_CPU_PendSVHandler      ; @ os_cpu_a.asm
                IMPORT  OS_CPU_SysTickHandler     ; @ os_cpu_c.c
                ; for os,   cy  100512  added
...
__Vectors       DCD     __initial_spTop           ; Top of Stack
                ...
                ; for os,   cy  100512  modify
                ; DCD     PendSV_Handler            ; PendSV Handler
                ; DCD     SysTick_Handler           ; SysTick Handler
                DCD     OS_CPU_PendSVHandler      ; @ os_cpu_a.asm
                DCD     OS_CPU_SysTickHandler     ; @ os_cpu_c.c
                ; for os,   cy  100512  modify
